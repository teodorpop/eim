...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (isChecked) {
            outState.putString("username", ((EditText) findViewById(R.id.username_edit_text)).getText().toString());
        }
        outState.putBoolean("remember_username", isChecked);
    }
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState.getString("username") != null) {
            ((EditText) findViewById(R.id.username_edit_text)).setText(savedInstanceState.getString("username"));
        }

        ((CheckBox) findViewById(R.id.remember_me_checkbox)).setChecked(savedInstanceState.getBoolean("remember_username"));
    }
